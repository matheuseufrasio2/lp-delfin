      ...
      <div className="mx-auto flex h-full max-w-[1120px] flex-col items-center justify-center">
        ...
        <div className="grid w-full grid-cols-1 gap-10 sm:grid-cols-2 lg:grid-cols-2">
          ...
          <BlurFade delay={0.25} inView>
            <div className="flex items-center justify-center">
              <h3 className="text-center text-xl md:text-start md:text-2xl">
                Com uma equipe dedicada ao planejamento estratégico e à geração
                de resultados, estamos sempre alinhados às tendências e
                inovações das redes sociais, garantindo que nossos clientes
                estejam à frente em um cenário competitivo.
              </h3>
            </div>
          </BlurFade>
        </div>
